...
const ProfileTabs = ({ currentEmail, name, handleUserUpdate }) => {
      ...
      <Tabs.Root className="TabsRoot" defaultValue="tab1">
        ...
        <Tabs.Content className="TabsContent" value="tab1">
          ...
          <fieldset className="Fieldset tabs-label">
            <label className="Label" type="email" htmlFor="name">
              Email
            </label>
            <input className="Input" id="name" defaultValue={currentEmail} />
          </fieldset>
      ...
      <fieldset className="Fieldset tabs-label">
        ...
        */}
          <div style={{ display: 'flex', marginTop: 20, justifyContent: 'flex-end' }}>
            <button onClick={handleUserUpdate} className="Button green">Save changes</button>
          </div>
        </Tabs.Content>
